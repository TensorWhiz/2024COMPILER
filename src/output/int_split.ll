...
while_5_22_cond:                                  ; preds = %while_5_22_whilestms, %split
  %r117 = load i32, i32* %r114, align 4
...
while_5_22_whilestms:                             ; preds = %while_5_22_cond
  %r119 = load i32, i32* %r114, align 4
  %r120 = getelementptr i32, i32* %r113, i32 %r119
  %r121 = load i32, i32* %r112, align 4
  %r122 = call i32 @mod(i32 %r121, i32 10)
  store i32 %r122, i32* %r120, align 4
  %r123 = load i32, i32* %r112, align 4
  %r124 = sdiv i32 %r123, 10
  store i32 %r124, i32* %r112, align 4
  %r125 = load i32, i32* %r114, align 4
  %r126 = sub i32 %r125, 1
  store i32 %r126, i32* %r114, align 4
  br label %while_5_22_cond
...
main:
  ...
  store i32 1478, i32* %r128, align 4
  %r130 = load i32, i32* %r128, align 4
  %r131 = getelementptr [4 x i32], [4 x i32]* %r129, i32 0, i32 0
  %r132 = call i32 @split(i32 %r130, i32* %r131)
  store i32 %r132, i32* %r128, align 4
  %r133 = alloca i32, align 4
  store i32 0, i32* %r127, align 4
  br label %while_5_43_cond

while_5_43_cond:                                  ; preds = %while_5_43_whilestms, %main
  %r134 = load i32, i32* %r127, align 4
  %r135 = icmp slt i32 %r134, 4
  br i1 %r135, label %while_5_43_whilestms, label %while_5_43_bre

while_5_43_whilestms:                             ; preds = %while_5_43_cond
  %r136 = load i32, i32* %r127, align 4
  %r137 = getelementptr [4 x i32], [4 x i32]* %r129, i32 0, i32 %r136
  %r138 = load i32, i32* %r137, align 4
  store i32 %r138, i32* %r133, align 4
  %r139 = load i32, i32* %r133, align 4
  call void @putint(i32 %r139)
  %r140 = load i32, i32* @newline, align 4
  call void @putch(i32 %r140)
  %r141 = load i32, i32* %r127, align 4
  %r142 = add i32 %r141, 1
  store i32 %r142, i32* %r127, align 4
  br label %while_5_43_cond

while_5_43_bre:                                   ; preds = %while_5_43_cond
  ret i32 0
}
