...
while_5_25_cond:                                  ; preds = %if_9_27_end, %while_5_15_bre
  %r111 = icmp sgt i32 1, 0
  br i1 %r111, label %while_5_25_whilestms, label %while_5_25_bre

while_5_25_whilestms:                             ; preds = %while_5_25_cond
  %r112 = call i32 @getch()
  %r113 = load i32, i32* @ascii_0, align 4
  %r114 = sub i32 %r112, %r113
  store i32 %r114, i32* %r101, align 4
  %r115 = load i32, i32* %r101, align 4
  %r116 = icmp sge i32 %r115, 0
  br i1 %r116, label %bb25_27_next, label %if_9_27_false

bb25_27_next:                                     ; preds = %while_5_25_whilestms
  %r117 = load i32, i32* %r101, align 4
  %r118 = icmp sle i32 %r117, 9
  br i1 %r118, label %if_9_27_true, label %if_9_27_false

if_9_27_true:                                     ; preds = %bb25_27_next
  %r119 = load i32, i32* %r100, align 4
  %r120 = mul i32 %r119, 10
  %r121 = load i32, i32* %r101, align 4
  %r122 = add i32 %r120, %r121
  store i32 %r122, i32* %r100, align 4
...
while_5_25_bre:                                   ; preds = %if_9_27_false, %while_5_25_cond
  %r123 = load i32, i32* %r100, align 4
  ret i32 %r123
}
...
mod:
  ...
  store i32 %r124, i32* %r125, align 4
  %r127 = alloca i32, align 4
  store i32 %r126, i32* %r127, align 4
  %r128 = load i32, i32* %r125, align 4
  %r129 = load i32, i32* %r125, align 4
  %r130 = load i32, i32* %r127, align 4
  %r131 = sdiv i32 %r129, %r130
  %r132 = load i32, i32* %r127, align 4
...
my_putint:
  ...
  store i32 %r135, i32* %r136, align 4
  %r137 = alloca [16 x i32], align 4
  %r138 = alloca i32, align 4
  store i32 0, i32* %r138, align 4
  br label %while_5_46_cond

while_5_46_cond:                                  ; preds = %while_5_46_whilestms, %my_putint
  %r139 = load i32, i32* %r136, align 4
...
while_5_46_whilestms:                             ; preds = %while_5_46_cond
  ...
  %r143 = load i32, i32* %r136, align 4
  %r144 = call i32 @mod(i32 %r143, i32 10)
  %r145 = load i32, i32* @ascii_0, align 4
  %r146 = add i32 %r144, %r145
  store i32 %r146, i32* %r142, align 4
  %r147 = load i32, i32* %r136, align 4
  %r148 = sdiv i32 %r147, 10
  store i32 %r148, i32* %r136, align 4
  %r149 = load i32, i32* %r138, align 4
  %r150 = add i32 %r149, 1
  store i32 %r150, i32* %r138, align 4
  br label %while_5_46_cond

while_5_46_bre:                                   ; preds = %while_5_46_cond
  br label %while_5_51_cond

while_5_51_cond:                                  ; preds = %while_5_51_whilestms, %while_5_46_bre
  %r151 = load i32, i32* %r138, align 4
...
while_5_51_whilestms:                             ; preds = %while_5_51_cond
  %r153 = load i32, i32* %r138, align 4
  %r154 = sub i32 %r153, 1
