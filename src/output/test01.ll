...
while_5_16_whilestms:                             ; preds = %while_5_16_cond
  ...
  %r107 = load i32, i32* %r101, align 4
  store i32 %r107, i32* %r106, align 4
  %r108 = load i32, i32* %r101, align 4
  %r109 = add i32 %r108, 1
  store i32 %r109, i32* %r101, align 4
  br label %while_5_16_cond
