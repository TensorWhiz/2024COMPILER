...
while_5_16_whilestms:                             ; preds = %while_5_16_cond
  ...
  %r108 = add i32 %r107, 1
  store i32 %r108, i32* %r100, align 4
  br label %while_5_16_cond
