...
main:
  ...
  store i32 0, i32* %r101, align 4
  store i32 0, i32* %r100, align 4
  br label %while_5_16_cond

while_5_16_cond:                                  ; preds = %while_5_16_whilestms, %main
  %r103 = load i32, i32* %r100, align 4
  %r104 = icmp slt i32 %r103, 10
  br i1 %r104, label %while_5_16_whilestms, label %while_5_16_bre

while_5_16_whilestms:                             ; preds = %while_5_16_cond
  %r105 = load i32, i32* %r100, align 4
  %r106 = getelementptr [10 x i32], [10 x i32]* %r102, i32 0, i32 %r105
  %r107 = load i32, i32* %r100, align 4
  %r108 = add i32 %r107, 1
  store i32 %r108, i32* %r106, align 4
  %r109 = load i32, i32* %r100, align 4
  %r110 = add i32 %r109, 1
  store i32 %r110, i32* %r100, align 4
  br label %while_5_16_cond

while_5_16_bre:                                   ; preds = %while_5_16_cond
  store i32 10, i32* %r115, align 4
  %r116 = call i32 @getint()
  store i32 %r116, i32* %r111, align 4
  %r117 = load i32, i32* %r115, align 4
  %r118 = sub i32 %r117, 1
  store i32 %r118, i32* %r112, align 4
  store i32 0, i32* %r113, align 4
  %r119 = load i32, i32* %r112, align 4
  %r120 = load i32, i32* %r113, align 4
  %r121 = add i32 %r119, %r120
  %r122 = sdiv i32 %r121, 2
  store i32 %r122, i32* %r114, align 4
  br label %while_5_31_cond

while_5_31_cond:                                  ; preds = %if_9_34_end, %while_5_16_bre
  %r123 = load i32, i32* %r114, align 4
  %r124 = getelementptr [10 x i32], [10 x i32]* %r102, i32 0, i32 %r123
  %r125 = load i32, i32* %r124, align 4
  %r126 = load i32, i32* %r111, align 4
  %r127 = icmp ne i32 %r125, %r126
  br i1 %r127, label %bb26_31_next, label %while_5_31_bre

bb26_31_next:                                     ; preds = %while_5_31_cond
  %r128 = load i32, i32* %r113, align 4
  %r129 = load i32, i32* %r112, align 4
  %r130 = icmp slt i32 %r128, %r129
  br i1 %r130, label %while_5_31_whilestms, label %while_5_31_bre

while_5_31_whilestms:                             ; preds = %bb26_31_next
  %r131 = load i32, i32* %r112, align 4
  %r132 = load i32, i32* %r113, align 4
  %r133 = add i32 %r131, %r132
  %r134 = sdiv i32 %r133, 2
  store i32 %r134, i32* %r114, align 4
...
if_9_34_true:                                     ; preds = %while_5_31_whilestms
  %r140 = load i32, i32* %r114, align 4
  %r141 = sub i32 %r140, 1
  store i32 %r141, i32* %r112, align 4
  br label %if_9_34_end

if_9_34_false:                                    ; preds = %while_5_31_whilestms
  %r142 = load i32, i32* %r114, align 4
  %r143 = add i32 %r142, 1
  store i32 %r143, i32* %r113, align 4
  br label %if_9_34_end

if_9_34_end:                                      ; preds = %if_9_34_false, %if_9_34_true
  br label %while_5_31_cond

while_5_31_bre:                                   ; preds = %bb26_31_next, %while_5_31_cond
  %r144 = load i32, i32* %r111, align 4
  %r145 = load i32, i32* %r114, align 4
  %r146 = getelementptr [10 x i32], [10 x i32]* %r102, i32 0, i32 %r145
  %r147 = load i32, i32* %r146, align 4
  %r148 = icmp eq i32 %r144, %r147
  br i1 %r148, label %if_5_44_true, label %if_5_44_false

if_5_44_true:                                     ; preds = %while_5_31_bre
  %r149 = load i32, i32* %r111, align 4
  call void @putint(i32 %r149)
  br label %if_5_44_end

if_5_44_false:                                    ; preds = %while_5_31_bre
  store i32 0, i32* %r111, align 4
  %r150 = load i32, i32* %r111, align 4
  call void @putint(i32 %r150)
  br label %if_5_44_end

if_5_44_end:                                      ; preds = %if_5_44_false, %if_5_44_true
  store i32 10, i32* %r111, align 4
  %r151 = load i32, i32* %r111, align 4
