...
popqueue:
  ...
  store i32 %r178, i32* %r175, align 4
...
while_5_80_cond:                                  ; preds = %while_9_86_bre, %same
  %r191 = load i32, i32* @h, align 4
  %r192 = load i32, i32* @tail, align 4
  %r193 = icmp slt i32 %r191, %r192
  br i1 %r193, label %while_5_80_whilestms, label %while_5_80_bre

while_5_80_whilestms:                             ; preds = %while_5_80_cond
  %r194 = call i32 @popqueue()
  store i32 %r194, i32* %r188, align 4
  %r195 = load i32, i32* %r188, align 4
  %r196 = load i32, i32* %r185, align 4
  %r197 = icmp eq i32 %r195, %r196
  br i1 %r197, label %if_9_82_true, label %if_9_82_false

if_9_82_true:                                     ; preds = %while_5_80_whilestms
  store i32 1, i32* %r187, align 4
...
if_13_88_end:                                     ; preds = %if_13_88_false, %if_13_88_true
  %r214 = load i32, i32* %r189, align 4
  %r215 = getelementptr [5005 x i32], [5005 x i32]* @next, i32 0, i32 %r214
  %r216 = load i32, i32* %r215, align 4
  store i32 %r216, i32* %r189, align 4
  br label %while_9_86_cond
...
while_5_95_cond:                                  ; preds = %while_5_95_whilestms, %while_5_80_bre
  %r217 = load i32, i32* %r189, align 4
  %r218 = load i32, i32* @tail, align 4
  %r219 = icmp sle i32 %r217, %r218
  br i1 %r219, label %while_5_95_whilestms, label %while_5_95_bre

while_5_95_whilestms:                             ; preds = %while_5_95_cond
  %r220 = load i32, i32* %r189, align 4
  %r221 = getelementptr [1005 x i32], [1005 x i32]* @que, i32 0, i32 %r220
  %r222 = load i32, i32* %r221, align 4
  store i32 %r222, i32* %r190, align 4
  %r223 = load i32, i32* %r190, align 4
  %r224 = getelementptr [1005 x i32], [1005 x i32]* @inq, i32 0, i32 %r223
  store i32 0, i32* %r224, align 4
  %r225 = load i32, i32* %r189, align 4
  %r226 = add i32 %r225, 1
  store i32 %r226, i32* %r189, align 4
  br label %while_5_95_cond

while_5_95_bre:                                   ; preds = %while_5_95_cond
  %r227 = load i32, i32* %r187, align 4
  ret i32 %r227
}
...
main:
  ...
  store i32 %r228, i32* @n, align 4
  %r229 = call i32 @quickread()
  store i32 %r229, i32* @m, align 4
  call void @init()
  %r230 = alloca i32, align 4
  store i32 0, i32* %r230, align 4
  %r231 = alloca i32, align 4
  store i32 0, i32* %r231, align 4
  %r232 = alloca i32, align 4
  store i32 0, i32* %r232, align 4
  br label %while_5_109_cond

while_5_109_cond:                                 ; preds = %if_9_114_end, %main
  %r233 = load i32, i32* @m, align 4
  %r234 = icmp ne i32 %r233, 0
  br i1 %r234, label %while_5_109_whilestms, label %while_5_109_bre

while_5_109_whilestms:                            ; preds = %while_5_109_cond
  %r235 = call i32 @getch()
  store i32 %r235, i32* %r230, align 4
  br label %while_9_111_cond

while_9_111_cond:                                 ; preds = %while_9_111_whilestms, %while_5_109_whilestms
  %r236 = load i32, i32* %r230, align 4
  %r237 = icmp ne i32 %r236, 81
  br i1 %r237, label %bb30_111_next, label %while_9_111_bre

bb30_111_next:                                    ; preds = %while_9_111_cond
  %r238 = load i32, i32* %r230, align 4
  %r239 = icmp ne i32 %r238, 85
  br i1 %r239, label %while_9_111_whilestms, label %while_9_111_bre

while_9_111_whilestms:                            ; preds = %bb30_111_next
  %r240 = call i32 @getch()
  store i32 %r240, i32* %r230, align 4
  br label %while_9_111_cond

while_9_111_bre:                                  ; preds = %bb30_111_next, %while_9_111_cond
  %r241 = load i32, i32* %r230, align 4
  %r242 = icmp eq i32 %r241, 81
  br i1 %r242, label %if_9_114_true, label %if_9_114_false

if_9_114_true:                                    ; preds = %while_9_111_bre
  %r243 = call i32 @quickread()
  store i32 %r243, i32* %r231, align 4
  %r244 = call i32 @quickread()
  store i32 %r244, i32* %r232, align 4
  %r245 = load i32, i32* %r231, align 4
  %r246 = load i32, i32* %r232, align 4
...
if_9_114_false:                                   ; preds = %while_9_111_bre
  ...
  store i32 %r248, i32* %r231, align 4
  %r249 = call i32 @quickread()
  store i32 %r249, i32* %r232, align 4
  %r250 = load i32, i32* %r231, align 4
  %r251 = load i32, i32* %r232, align 4
  call void @addedge(i32 %r250, i32 %r251)
  br label %if_9_114_end

if_9_114_end:                                     ; preds = %if_9_114_false, %if_9_114_true
  %r252 = load i32, i32* @m, align 4
  %r253 = sub i32 %r252, 1
  store i32 %r253, i32* @m, align 4
  br label %while_5_109_cond
