...
bb21_16_next:                                     ; preds = %while_5_16_cond
  %r110 = load i32, i32* %r103, align 4
  %r111 = load i32, i32* @N, align 4
  %r112 = icmp slt i32 %r110, %r111
  br i1 %r112, label %while_5_16_whilestms, label %while_5_16_bre

while_5_16_whilestms:                             ; preds = %bb21_16_next
  %r113 = load i32, i32* %r103, align 4
  %r114 = add i32 %r113, 1
  store i32 %r114, i32* %r103, align 4
  br label %while_5_16_cond

while_5_16_bre:                                   ; preds = %bb21_16_next, %while_5_16_cond
  %r115 = load i32, i32* @N, align 4
  store i32 %r115, i32* %r104, align 4
  br label %while_5_22_cond

while_5_22_cond:                                  ; preds = %while_5_22_whilestms, %while_5_16_bre
  %r116 = load i32, i32* %r104, align 4
  %r117 = load i32, i32* %r103, align 4
...
while_5_22_whilestms:                             ; preds = %while_5_22_cond
  %r120 = load i32, i32* %r104, align 4
  %r121 = sub i32 %r120, 1
  store i32 %r121, i32* %r119, align 4
  ...
  store i32 %r129, i32* %r128, align 4
  %r130 = load i32, i32* %r104, align 4
  %r131 = sub i32 %r130, 1
  store i32 %r131, i32* %r104, align 4
  br label %while_5_22_cond
