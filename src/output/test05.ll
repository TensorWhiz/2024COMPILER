...
factor:
  ...
  store i32 1, i32* %r102, align 4
  br label %while_5_19_cond

while_5_19_cond:                                  ; preds = %if_9_21_end, %factor
  %r104 = load i32, i32* %r102, align 4
  %r105 = load i32, i32* %r101, align 4
  %r106 = add i32 %r105, 1
  %r107 = icmp slt i32 %r104, %r106
  br i1 %r107, label %while_5_19_whilestms, label %while_5_19_bre

while_5_19_whilestms:                             ; preds = %while_5_19_cond
  %r108 = load i32, i32* %r101, align 4
  %r109 = load i32, i32* %r102, align 4
  %r110 = sdiv i32 %r108, %r109
  %r111 = load i32, i32* %r102, align 4
  %r112 = mul i32 %r110, %r111
  %r113 = load i32, i32* %r101, align 4
  %r114 = icmp eq i32 %r112, %r113
  br i1 %r114, label %if_9_21_true, label %if_9_21_false

if_9_21_true:                                     ; preds = %while_5_19_whilestms
  %r115 = load i32, i32* %r103, align 4
  %r116 = load i32, i32* %r102, align 4
  %r117 = add i32 %r115, %r116
  store i32 %r117, i32* %r103, align 4
  br label %if_9_21_end

if_9_21_false:                                    ; preds = %while_5_19_whilestms
  br label %if_9_21_end

if_9_21_end:                                      ; preds = %if_9_21_false, %if_9_21_true
  %r118 = load i32, i32* %r102, align 4
  %r119 = add i32 %r118, 1
  store i32 %r119, i32* %r102, align 4
  br label %while_5_19_cond

while_5_19_bre:                                   ; preds = %while_5_19_cond
  %r120 = load i32, i32* %r103, align 4
  ret i32 %r120
}
