...
while_5_26_whilestms:                             ; preds = %while_5_26_cond
  ...
  store i32 %r110, i32* %r105, align 4
...
while_9_38_whilestms:                             ; preds = %while_9_38_cond
  ...
  %r130 = load i32, i32* %r129, align 4
...
if_13_39_true:                                    ; preds = %bb39_39_next
  ...
  store i32 %r138, i32* %r120, align 4
...
while_9_47_whilestms:                             ; preds = %while_9_47_cond
  ...
  %r153 = load i32, i32* %r152, align 4
...
if_13_48_true:                                    ; preds = %while_9_47_whilestms
  ...
  %r167 = load i32, i32* %r166, align 4
...
if_17_49_true:                                    ; preds = %if_13_48_true
  ...
  %r174 = load i32, i32* %r173, align 4
  ...
  %r180 = load i32, i32* %r179, align 4
...
while_5_93_cond:                                  ; preds = %while_5_93_whilestms, %while_5_83_bre
  %r229 = load i32, i32* %r186, align 4
  %r230 = load i32, i32* @n, align 4
...
while_5_93_whilestms:                             ; preds = %while_5_93_cond
  %r232 = load i32, i32* %r186, align 4
  %r233 = getelementptr [16 x i32], [16 x i32]* @dis, i32 0, i32 %r232
  %r234 = load i32, i32* %r233, align 4
  call void @putint(i32 %r234)
  call void @putch(i32 32)
  %r235 = load i32, i32* %r186, align 4
  %r236 = add i32 %r235, 1
  store i32 %r236, i32* %r186, align 4
  br label %while_5_93_cond
