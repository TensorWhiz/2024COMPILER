...
bb20_10_next:                                     ; preds = %uniquePaths
...
while_5_22_cond:                                  ; preds = %while_5_22_whilestms, %if_5_10_end
  %r114 = load i32, i32* %r109, align 4
  %r115 = load i32, i32* %r101, align 4
...
while_5_22_whilestms:                             ; preds = %while_5_22_cond
  %r117 = load i32, i32* %r109, align 4
  %r118 = mul i32 %r117, 3
  %r119 = load i32, i32* %r103, align 4
  %r120 = add i32 %r118, %r119
  %r121 = sub i32 %r120, 1
  store i32 %r121, i32* %r111, align 4
  %r122 = load i32, i32* %r111, align 4
  %r123 = getelementptr [9 x i32], [9 x i32]* %r108, i32 0, i32 %r122
  store i32 1, i32* %r123, align 4
  %r124 = load i32, i32* %r109, align 4
  %r125 = add i32 %r124, 1
  store i32 %r125, i32* %r109, align 4
  br label %while_5_22_cond
...
while_5_28_cond:                                  ; preds = %while_5_28_whilestms, %while_5_22_bre
  %r126 = load i32, i32* %r109, align 4
...
while_5_28_whilestms:                             ; preds = %while_5_28_cond
  %r129 = load i32, i32* %r101, align 4
  %r130 = sub i32 %r129, 1
  %r131 = mul i32 %r130, 3
  %r132 = load i32, i32* %r109, align 4
  %r133 = add i32 %r131, %r132
  store i32 %r133, i32* %r111, align 4
  %r134 = load i32, i32* %r111, align 4
  %r135 = getelementptr [9 x i32], [9 x i32]* %r108, i32 0, i32 %r134
  store i32 1, i32* %r135, align 4
  %r136 = load i32, i32* %r109, align 4
  %r137 = add i32 %r136, 1
  store i32 %r137, i32* %r109, align 4
  br label %while_5_28_cond

while_5_28_bre:                                   ; preds = %while_5_28_cond
  %r138 = load i32, i32* %r101, align 4
  %r139 = sub i32 %r138, 2
  store i32 %r139, i32* %r109, align 4
  br label %while_5_34_cond

while_5_34_cond:                                  ; preds = %while_9_36_bre, %while_5_28_bre
  %r140 = load i32, i32* %r109, align 4
  %r141 = sub i32 0, 1
...
while_5_34_whilestms:                             ; preds = %while_5_34_cond
  %r143 = load i32, i32* %r103, align 4
  %r144 = sub i32 %r143, 2
  store i32 %r144, i32* %r110, align 4
  br label %while_9_36_cond

while_9_36_cond:                                  ; preds = %while_9_36_whilestms, %while_5_34_whilestms
  %r145 = load i32, i32* %r110, align 4
  %r146 = sub i32 0, 1
  %r147 = icmp sgt i32 %r145, %r146
  br i1 %r147, label %while_9_36_whilestms, label %while_9_36_bre

while_9_36_whilestms:                             ; preds = %while_9_36_cond
  %r148 = load i32, i32* %r109, align 4
  %r149 = mul i32 %r148, 3
  %r150 = load i32, i32* %r110, align 4
  %r151 = add i32 %r149, %r150
  store i32 %r151, i32* %r111, align 4
  %r152 = load i32, i32* %r109, align 4
  %r153 = add i32 %r152, 1
  %r154 = mul i32 %r153, 3
  %r155 = load i32, i32* %r110, align 4
  %r156 = add i32 %r154, %r155
  store i32 %r156, i32* %r112, align 4
  %r157 = load i32, i32* %r109, align 4
  %r158 = mul i32 %r157, 3
  %r159 = load i32, i32* %r110, align 4
  %r160 = add i32 %r158, %r159
  %r161 = add i32 %r160, 1
  store i32 %r161, i32* %r113, align 4
  ...
  %r172 = sub i32 %r171, 1
  store i32 %r172, i32* %r110, align 4
  br label %while_9_36_cond

while_9_36_bre:                                   ; preds = %while_9_36_cond
  %r173 = load i32, i32* %r109, align 4
  %r174 = sub i32 %r173, 1
  store i32 %r174, i32* %r109, align 4
  br label %while_5_34_cond
...
main:
  ...
  store i32 3, i32* %r178, align 4
  %r179 = load i32, i32* %r178, align 4
  %r180 = load i32, i32* %r178, align 4
  %r181 = call i32 @uniquePaths(i32 %r179, i32 %r180)
  store i32 %r181, i32* %r177, align 4
  %r182 = load i32, i32* %r177, align 4
  ret i32 %r182
}
