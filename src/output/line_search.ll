...
while_5_16_bre:                                   ; preds = %while_5_16_cond
  ...
  store i32 0, i32* %r123, align 4
  store i32 0, i32* %r100, align 4
  store i32 0, i32* %r124, align 4
  br label %while_5_36_cond

while_5_36_cond:                                  ; preds = %if_9_38_end, %while_5_16_bre
  %r125 = load i32, i32* %r100, align 4
  %r126 = icmp slt i32 %r125, 10
  br i1 %r126, label %bb21_36_next, label %while_5_36_bre

bb21_36_next:                                     ; preds = %while_5_36_cond
  %r127 = load i32, i32* %r123, align 4
...
if_9_38_true:                                     ; preds = %while_5_36_whilestms
  ...
  %r134 = load i32, i32* %r100, align 4
  store i32 %r134, i32* %r124, align 4
  br label %if_9_38_end

if_9_38_false:                                    ; preds = %while_5_36_whilestms
  br label %if_9_38_end

if_9_38_end:                                      ; preds = %if_9_38_false, %if_9_38_true
  %r135 = load i32, i32* %r100, align 4
  %r136 = add i32 %r135, 1
  store i32 %r136, i32* %r100, align 4
  br label %while_5_36_cond

while_5_36_bre:                                   ; preds = %bb21_36_next, %while_5_36_cond
  %r137 = load i32, i32* %r123, align 4
  %r138 = icmp eq i32 %r137, 1
  br i1 %r138, label %if_5_47_true, label %if_5_47_false

if_5_47_true:                                     ; preds = %while_5_36_bre
  %r139 = load i32, i32* %r124, align 4
