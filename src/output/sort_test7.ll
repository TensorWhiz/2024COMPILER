...
Merge:
  ...
  br label %while_5_23_cond

while_5_23_cond:                                  ; preds = %while_5_23_whilestms, %Merge
  %r121 = load i32, i32* %r118, align 4
  %r122 = load i32, i32* %r107, align 4
  %r123 = icmp slt i32 %r121, %r122
  br i1 %r123, label %while_5_23_whilestms, label %while_5_23_bre

while_5_23_whilestms:                             ; preds = %while_5_23_cond
  %r124 = load i32, i32* %r118, align 4
  %r125 = load i32, i32* %r102, align 4
  %r126 = add i32 %r124, %r125
  store i32 %r126, i32* %r120, align 4
...
while_5_23_bre:                                   ; preds = %while_5_23_cond
  br label %while_5_28_cond

while_5_28_cond:                                  ; preds = %while_5_28_whilestms, %while_5_23_bre
  %r134 = load i32, i32* %r119, align 4
  %r135 = load i32, i32* %r112, align 4
  %r136 = icmp slt i32 %r134, %r135
  br i1 %r136, label %while_5_28_whilestms, label %while_5_28_bre

while_5_28_whilestms:                             ; preds = %while_5_28_cond
  %r137 = load i32, i32* %r119, align 4
  %r138 = load i32, i32* %r104, align 4
...
while_5_28_bre:                                   ; preds = %while_5_28_cond
  ...
  br label %while_5_37_cond

while_5_37_cond:                                  ; preds = %if_9_39_end, %while_5_28_bre
  %r150 = load i32, i32* %r118, align 4
  %r151 = load i32, i32* %r107, align 4
  %r152 = icmp ne i32 %r150, %r151
  br i1 %r152, label %bb22_37_next, label %while_5_37_bre

bb22_37_next:                                     ; preds = %while_5_37_cond
  %r153 = load i32, i32* %r119, align 4
  %r154 = load i32, i32* %r112, align 4
  %r155 = icmp ne i32 %r153, %r154
  br i1 %r155, label %while_5_37_whilestms, label %while_5_37_bre
...
if_9_39_true:                                     ; preds = %while_5_37_whilestms
  ...
  %r171 = load i32, i32* %r118, align 4
  %r172 = add i32 %r171, 1
  store i32 %r172, i32* %r118, align 4
  br label %if_9_39_end

if_9_39_false:                                    ; preds = %while_5_37_whilestms
  ...
  %r180 = load i32, i32* %r119, align 4
  %r181 = add i32 %r180, 1
  store i32 %r181, i32* %r119, align 4
  br label %if_9_39_end

if_9_39_end:                                      ; preds = %if_9_39_false, %if_9_39_true
  br label %while_5_37_cond

while_5_37_bre:                                   ; preds = %bb22_37_next, %while_5_37_cond
  br label %while_5_50_cond

while_5_50_cond:                                  ; preds = %while_5_50_whilestms, %while_5_37_bre
  %r182 = load i32, i32* %r118, align 4
  %r183 = load i32, i32* %r107, align 4
  %r184 = icmp slt i32 %r182, %r183
  br i1 %r184, label %while_5_50_whilestms, label %while_5_50_bre

while_5_50_whilestms:                             ; preds = %while_5_50_cond
  ...
  %r192 = load i32, i32* %r118, align 4
  %r193 = add i32 %r192, 1
  store i32 %r193, i32* %r118, align 4
  br label %while_5_50_cond

while_5_50_bre:                                   ; preds = %while_5_50_cond
  br label %while_5_55_cond

while_5_55_cond:                                  ; preds = %while_5_55_whilestms, %while_5_50_bre
  %r194 = load i32, i32* %r119, align 4
  %r195 = load i32, i32* %r112, align 4
  %r196 = icmp slt i32 %r194, %r195
  br i1 %r196, label %while_5_55_whilestms, label %while_5_55_bre

while_5_55_whilestms:                             ; preds = %while_5_55_cond
  ...
  %r204 = load i32, i32* %r119, align 4
  %r205 = add i32 %r204, 1
  store i32 %r205, i32* %r119, align 4
  br label %while_5_55_cond

while_5_55_bre:                                   ; preds = %while_5_55_cond
  ret i32 0
}
...
MergeSort:
  ...
  store i32 %r209, i32* %r210, align 4
  %r211 = load i32, i32* %r208, align 4
  %r212 = load i32, i32* %r210, align 4
  %r213 = icmp slt i32 %r211, %r212
  br i1 %r213, label %if_5_65_true, label %if_5_65_false

if_5_65_true:                                     ; preds = %MergeSort
  %r215 = load i32, i32* %r208, align 4
  %r216 = load i32, i32* %r210, align 4
...
if_5_65_end:                                      ; preds = %if_5_65_false, %if_5_65_true
  ret i32 0
}
